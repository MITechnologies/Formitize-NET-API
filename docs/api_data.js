define({ "api": [
  ...
  },
  {
    ...
    "name": "DatabaseDelete",
    "order": "3",
    "description": "<p>Deletes the table.</p>",
    "group": "Database",
    "version": "1.0.0",
    "examples": [
      {
  ...
  {
    "type": "delete",
    "url": "/database/:tablename/truncate",
    "title": "Truncate Data From A Table",
    "name": "DatabaseTruncate",
    "order": "4",
    "description": "<p>Permanently remove all records from a specified table. Unlike the delete endpoint, this physically removes all rows. Useful for wiping a table before re-importing fresh data.</p>",
    "group": "Database",
    "version": "1.0.0",
    "examples": [
      {
        "title": "CURL Example",
        "content": "curl -A YourCompany -u admin:password -X \"DELETE\" https://service.formitize.com/api/rest/v2/database/example_table/truncate",
        "type": "json"
      }
    ],
    "success": {
      "examples": [
        {
          "title": "Response Body Example:",
          "content": "{\n\"payload\": {\n\"result\": \"success\",\n\"note\": \"Database records truncated.\"\n}\n}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "group": "Task",
    "version": "1.0.0",
    "description": "<p>Soft delete a task by ID. The task is marked as deleted but not permanently removed.</p>",
    "examples": [
      {
        "title": "CURL Example",
        "content": "curl -H \"Authorization: Bearer TOKEN\" -X \"DELETE\" https://service.formitize.com/api/rest/v2/crm/task/123",
        "type": "json"
      }
    ],
    "success": {
    ...
    "filename": "app/system/class/api/rest/v1/crm/task/_apidoc.js",
    "groupTitle": "Task"
  },
  {
    "type": "get",
    ...
    "group": "Task",
    "version": "1.0.0",
    "description": "<p>Get a single task by ID, including enriched relatedTo data and attachments.</p>",
    "examples": [
      {
        "title": "CURL Example",
        "content": "curl -H \"Authorization: Bearer TOKEN\" https://service.formitize.com/api/rest/v2/crm/task/123",
        "type": "json"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "group": "Task",
    "version": "1.0.0",
    "description": "<p>Get a paginated list of tasks with optional filters.</p>",
    "parameter": {
      "fields": {
        "Optional": [
          {
            ...
            "optional": true,
            "field": "status",
            "description": "<p>Filter by task status.</p>"
          },
          {
            "group": "Optional",
            "type": "number",
            "optional": true,
            "field": "assignedTo",
            "description": "<p>Filter by assigned user ID.</p>"
          },
          {
            "group": "Optional",
            "type": "number",
            "optional": true,
            "field": "clientID",
            "description": "<p>Filter by related contact (client) ID.</p>"
          },
          {
            "group": "Optional",
            "type": "string",
            "optional": true,
            "field": "taskType",
            "description": "<p>Filter by task type.</p>"
          },
          {
            "group": "Optional",
            "type": "string",
            ...
            "optional": true,
            "field": "from",
            "description": "<p>Filter tasks with a due date on or after this date.</p>"
          },
          {
            "group": "Optional",
            "type": "string",
            ...
            "optional": true,
            "field": "to",
            "description": "<p>Filter tasks with a due date on or before this date.</p>"
          },
          {
            "group": "Optional",
            "type": "string",
            "optional": true,
            "field": "search",
            "description": "<p>Search task title and description.</p>"
          },
          {
            "group": "Optional",
            "type": "number",
            ...
            "description": "<p>Filter by external source type.</p>"
          },
          {
            "group": "Optional",
            "type": "string",
            ...
            "description": "<p>Filter by external source ID.</p>"
          },
          {
            "group": "Optional",
            "type": "number",
            ...
            "field": "page",
            "defaultValue": "1",
            "description": "<p>Page number, starting from 1.</p>"
          },
          {
            "group": "Optional",
            "type": "number",
          ...
          },
          {
            ...
            "field": "order",
            "defaultValue": "desc",
            "description": "<p>Sort direction on due date.</p>"
          }
        ]
      }
    },
    "examples": [
      {
        "title": "CURL Example",
        "content": "curl -H \"Authorization: Bearer TOKEN\" https://service.formitize.com/api/rest/v2/crm/task/?status=open&page=1&limit=10",
        "type": "json"
      }
    ],
    "success": {
        ...
        "Body": [
          {
            ...
            "optional": false,
            "field": "title",
            "description": "<p>The task title (required).</p>"
          },
          {
            "group": "Body",
            "type": "string",
          ...
          },
          {
            ...
            "optional": true,
            "field": "taskType",
            "description": "<p>Task type label (e.g. &quot;Call&quot;, &quot;Email&quot;, &quot;Meeting&quot;).</p>"
          },
          {
            "group": "Body",
            "type": "number",
            "optional": true,
            "field": "dueDate",
            "description": "<p>Due date as unix timestamp or date string.</p>"
          },
          {
            "group": "Body",
            "type": "number",
            "optional": true,
            "field": "assignedTo",
            "description": "<p>User ID to assign the task to.</p>"
          },
          {
            "group": "Body",
            "type": "number",
            ...
            "field": "status",
            "defaultValue": "0",
            "description": "<p>Task status. 0 = open, 1 = closed.</p>"
          },
          {
            "group": "Body",
            "type": "object",
            "optional": true,
            "field": "relatedTo",
            "description": "<p>Related entities object.</p>"
          },
          {
            "group": "Body",
            "type": "object",
            "optional": true,
            "field": "relatedTo.contact",
            "description": "<p>Related contacts keyed by client ID.</p>"
          },
          {
            "group": "Body",
            "type": "object",
            "optional": true,
            "field": "relatedTo.job",
            "description": "<p>Related jobs keyed by job ID.</p>"
          },
          {
            "group": "Body",
            "type": "object",
            "optional": true,
            "field": "relatedTo.person",
            "description": "<p>Related persons keyed by contact ID.</p>"
          },
          {
            "group": "Body",
            "type": "string[]",
            "optional": true,
            "field": "tags",
            "description": "<p>Array of tag strings.</p>"
          },
          {
            "group": "Body",
            "type": "number[]",
            "optional": true,
            "field": "attachments",
            "description": "<p>Array of resource IDs to attach.</p>"
          },
          {
            "group": "Body",
            "type": "number",
            "optional": true,
            "field": "externalSource",
            "description": "<p>External source type identifier.</p>"
          },
          {
            "group": "Body",
            "type": "string",
            "optional": true,
            "field": "externalSourceID",
            "description": "<p>External source record ID.</p>"
          }
        ],
        "Workflow": [
          {
            ...
            "optional": true,
            "field": "workflowID",
            "description": "<p>Workflow template handling. Set to <code>&quot;template&quot;</code> to create a new workflow template. Set to an existing template ID to assign it. Set to <code>0</code> or omit for no workflow.</p>"
          },
          {
            "group": "Workflow",
            "type": "string",
            "optional": true,
            "field": "workflowName",
            "description": "<p>Name for the new template (required when workflowID is &quot;template&quot;).</p>"
          },
          {
            "group": "Workflow",
            "type": "object[]",
            "optional": true,
            "field": "workflow",
            "description": "<p>Array of workflow steps.</p>"
          },
          {
            "group": "Workflow",
            "type": "string",
            "optional": false,
            "field": "workflow.name",
            "description": "<p>The step name/label.</p>"
          },
          {
            "group": "Workflow",
            "type": "boolean",
            ...
            "field": "workflow.done",
            "defaultValue": "false",
            "description": "<p>Whether this step is completed.</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Request Body Example:",
          "content": "{\n    \"title\": \"Follow up with client\",\n    \"description\": \"Call regarding the quote we sent last week\",\n    \"taskType\": \"Call\",\n    \"dueDate\": 1713168000,\n    \"assignedTo\": 45,\n    \"relatedTo\": {\n        \"contact\": {\n            \"77\": {\"id\": \"77\"}\n        }\n    },\n    \"tags\": [\"urgent\", \"sales\"],\n    \"workflow\": [\n        {\"name\": \"Make call\", \"done\": false},\n        {\"name\": \"Send email summary\", \"done\": false},\n        {\"name\": \"Update CRM\", \"done\": false}\n    ],\n    \"workflowID\": \"template\",\n    \"workflowName\": \"Client Follow Up\"\n}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "group": "Task",
    "version": "1.0.0",
    "description": "<p>Update an existing task. Only fields provided in the body will be updated.</p>",
    "parameter": {
      "fields": {
        "Body": [
          {
            ...
            "optional": true,
            "field": "title",
            "description": "<p>The task title.</p>"
          },
          {
            "group": "Body",
            "type": "string",
          ...
          },
          {
            ...
            "optional": true,
            "field": "taskType",
            "description": "<p>Task type label.</p>"
          },
          {
            "group": "Body",
            "type": "number",
          ...
          },
          {
            ...
            "optional": true,
            "field": "status",
            "description": "<p>Task status. 0 = open, 1 = closed. Changing status creates CRM history entries.</p>"
          },
          {
            "group": "Body",
            "type": "object",
          ...
          },
          {
            ...
            "optional": true,
            "field": "attachments",
            "description": "<p>Array of resource IDs.</p>"
          },
          {
            "group": "Body",
            "type": "number",
        ...
        "Workflow": [
          {
            ...
            "optional": true,
            "field": "workflowID",
            "description": "<p>Workflow template handling.</p>"
          },
          {
            "group": "Workflow",
            "type": "string",
            "optional": true,
            "field": "workflowName",
            "description": "<p>Name for the new template (when workflowID is &quot;template&quot;).</p>"
          },
          {
            "group": "Workflow",
            "type": "object[]",
      ...
      "examples": [
        {
          "title": "Request Body Example - Close task and mark workflow step done:",
          "content": "{\n    \"status\": 1,\n    \"workflow\": [\n        {\"name\": \"Make call\", \"done\": true},\n        {\"name\": \"Send email summary\", \"done\": true},\n        {\"name\": \"Update CRM\", \"done\": true}\n    ]\n}",
          "type": "json"
        }
      ]
    },
